...
//	private Set<Banggia> banggias = new HashSet<Banggia>(0);
	...
	public Mathang(String mamh, Chatlieu chatlieu, Loaikh loaikh, Loaimh loaimh, Nhanhieu nhanhieu, String tenmh,
			String mota, int trangthai, Integer cachlam, Set<Ctpx> ctpxes, List<Hinhanhmh> hinhanhmhs,
			List<Banggia> banggias, Set<Ctpn> ctpns, Set<Cthd> cthds, Set<Ctddh> ctddhs, Set<Ctdkm> ctdkms,
