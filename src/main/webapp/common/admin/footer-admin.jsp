...
<%@include file="/common/taglib.jsp" %>
    ...
    ></script>
    <script src=" <c:url value='/templates/scripts/loading-animation.js'/>" />
    <script>
      ...
      // event occuring when scroll the page
    ...
    <script src="<c:url value='/templates/scripts/item-detail.js'/>" />
    <script src="<c:url value='/templates/scripts/add-item-to-user-bag.js' />" />